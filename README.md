...
Projeto de estudo prático em DevOps, construído de forma incremental: de um servidor Linux único até uma arquitetura completa com containers, CI/CD, observabilidade, Infraestrutura como Código e Kubernetes.
...
Linux (Ubuntu Server) · SSH · UFW · Nginx · Docker · Docker Compose · Git/GitHub
